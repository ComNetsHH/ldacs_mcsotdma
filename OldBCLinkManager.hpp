...
#ifndef TUHH_INTAIRNET_MC_SOTDMA_OLDBCLINKMANAGER_HPP
#define TUHH_INTAIRNET_MC_SOTDMA_OLDBCLINKMANAGER_HPP
...
namespace TUHH_INTAIRNET_MCSOTDMA {
	 ...
	 */
	class OldBCLinkManager : public OldLinkManager {
	...
	public:
		 ...
		 */
		OldBCLinkManager(const MacId& link_id, ReservationManager* reservation_manager, MCSOTDMA_Mac* mac, unsigned int num_slots_contention_estimate);

		OldBCLinkManager(const MacId& link_id, ReservationManager* reservation_manager, MCSOTDMA_Mac* mac);
...
#endif //TUHH_INTAIRNET_MC_SOTDMA_OLDBCLINKMANAGER_HPP
