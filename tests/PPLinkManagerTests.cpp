...
//			coutd.setVerbose(true);
			link_manager->processLinkReplyMessage((const L2HeaderLinkEstablishmentReply*&) link_reply->getHeaders().at(reply_index), (const L2Packet::Payload*&) link_reply->getPayloads().at(reply_index), ((L2HeaderBase*) link_reply->getHeaders().at(0))->src_id);
//			coutd.setVerbose(false);
