...
TUHH_INTAIRNET_MCSOTDMA::Reservation::Reservation(TUHH_INTAIRNET_MCSOTDMA::LinkId owner,
                                                  TUHH_INTAIRNET_MCSOTDMA::Reservation::Action action)
                                                  : owner(std::move(owner)), action(action) {}

const TUHH_INTAIRNET_MCSOTDMA::LinkId& TUHH_INTAIRNET_MCSOTDMA::Reservation::getOwner() const {
	return this->owner;
}
...
TUHH_INTAIRNET_MCSOTDMA::Reservation::Reservation(TUHH_INTAIRNET_MCSOTDMA::LinkId owner) : owner(std::move(owner)), action(Action::UNSET) {}
